...
defaultMap = {0: "",  # NUL (Null char)
              ...
              58: ":",  # : (Colon)
              59: ";",  # ; (Semicolon)
              60: "LeftShift+,",  # < (Less than) -> Shift + Comma on C64
              61: "=",  # = (Equals)
              62: "LeftShift+.",  # > (Greater than) -> Shift + Period on C64
              63: "LeftShift+/",  # ? (Question mark) -> Shift + Slash on C64
              64: "@",  # @ (At symbol)
              65: "",  # A (Uppercase A)
              66: "",  # B (Uppercase B)
              67: "",  # C (Uppercase C)
              ...
              89: "",  # Y (Uppercase Y)
              90: "",  # Z (Uppercase Z)
              91: "LeftShift+:",  # [ (Opening bracket) -> Shift + Colon on C64
              92: "Restore",  # \ (Backslash)
              93: "LeftShift+;",  # ] (Closing bracket) -> Shift + Semicolon on C64
              94: "",  # ^ (Caret - circumflex)
              95: "",  # _ (Underscore)
              96: "",  # ` (Grave accent)
              97: "",  # a (Lowercase a)
