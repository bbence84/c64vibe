...
555 IF I=4 AND L=9 THEN PRINT "MEGTOLTOTTED A VODROT VIZZEL.":IL(5)=0:RETURN
560 IF I=2 AND L=7 THEN PRINT "A ROKA ORUL A BOGYONAK! KAPTAL EGY KULCSOT!":IL(2)=-1:IL(7)=0:RETURN
...
3000 DATA "REPA",1,"KEK BOGYO",4,"TOLL",8,"VODOR",13,"VIZ",100,"VARAZSMAKK",6,"ROZSDAS KULCS",100,"KOTEL",14,"DRAGAKO",19,"ARANY REPA",20
9000 REM INTRO
